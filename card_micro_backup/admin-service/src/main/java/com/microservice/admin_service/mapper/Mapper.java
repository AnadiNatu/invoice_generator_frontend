package com.microservice.admin_service.mapper;
...
public class Mapper {
    ...
    public Cards mapToCreateCard(CreateCardDTO cardDTO) throws IllegalAccessException {
        ...
        cards.setIssueAt(convertDateToLocalDate(new Date()));
    ...
    public AllCardInfoDTO mapFromCardsToAllCardInfoDTO(Cards cards){
        ...
        cardDTO.setIssueAt(cards.getIssueAt());
    ...
    public List<CardExcelDTO> toCardExcelDto(List<Cards> cardsList) {
        ...
        for (Cards card : cardsList){
            ...
            excelDTO.setIssuedAt(card.getIssueAt());
    ...
    public Users mapFromUserDtoToUser(UserDTO dto){
